...
# Present a classic joystick-shaped capability set so legacy DirectInput
# code sees expected counts/types (8 axes + up to 4 POV hats).
AXIS_CAPS = [
	...
	(ecodes.ABS_HAT1X, AbsInfo(value=0, min=-1, max=1, fuzz=0, flat=0, resolution=0)),
	(ecodes.ABS_HAT1Y, AbsInfo(value=0, min=-1, max=1, fuzz=0, flat=0, resolution=0)),
	(ecodes.ABS_HAT2X, AbsInfo(value=0, min=-1, max=1, fuzz=0, flat=0, resolution=0)),
	(ecodes.ABS_HAT2Y, AbsInfo(value=0, min=-1, max=1, fuzz=0, flat=0, resolution=0)),
	(ecodes.ABS_HAT3X, AbsInfo(value=0, min=-1, max=1, fuzz=0, flat=0, resolution=0)),
	(ecodes.ABS_HAT3Y, AbsInfo(value=0, min=-1, max=1, fuzz=0, flat=0, resolution=0)),
]
...
if __name__ == "__main__":
	print("MFD combo active. Press Ctrl+C to exit.")
